# Time Series Analysis - Multivariate and Univariate Models
...
processAllFiles <- function(fname) {
  ...
  ts_data <- ts(df[, c("avgRnkWeek", "N_Tweets")], frequency = 1)
  ...
  ##################################################################################
  # Univariate Amazon: LINEAR for lags 1-5
  ##################################################################################
  ...
  ##################################################################################
  # Univariate Amazon: NNET for lags 1-5
  ##################################################################################
